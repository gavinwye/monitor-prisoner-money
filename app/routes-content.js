	...
	module.exports = {
		...
		frequencyOfTransactionsQuestionOne: 'More than XX credits from the same debit card or bank account to any prisoner?',
		frequencyOfTransactionsQuestionOneHint: 'If you select Yes, you can determine the amount and frequency.',
		frequencyOfTransactionsQuestionTwo: 'More than XX disbursements from the same debit card or bank account to any prisoner?',
		...
		prisonersHeadingTwo: '',
		prisonersQuestionOne: 'That prisoner is sent money from XX debit cards or bank accounts within XX weeks?',
		prisonersQuestionTwo: 'That prisoner sends out money from XX debit cards or bank accounts within XX weeks?',
